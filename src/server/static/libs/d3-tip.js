...
d3.tip = function () {
    ...
    tip.show = function () {
        ...
        var coords;
        var scrollTop = rootElement ?
            rootElement.scrollTop :
            (document.documentElement.scrollTop || document.body.scrollTop);
        var scrollLeft = rootElement ?
    ...
    var directions = Object.keys(directionCallbacks);
    ...
    function initNode() {
        var divNode = d3.select(document.createElement("div"));
        divNode
            .style("position", "absolute")
            .style("top", 0)
            .style("display", "none")
