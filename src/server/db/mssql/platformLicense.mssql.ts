...
export function PlatformLicenseMSSql(app: express.Application) {
...
//////////////////////////////////////////
export function CreatePlatformLicense (
	platformHash : string,
	quality : number,
	speech : number,
	expirationDate : Date,
	...
	.input('QualityLicense', sql.Int, quality)
	.input('SpeechLicense', sql.VarChar(100), speech)
	.input('ExpirationDate', sql.Date, expirationDate)
	.input('User', sql.VarChar(50), user)
    .execute('CreatePlatformLicense')
    .then(
        (recordsets: any)  => {
