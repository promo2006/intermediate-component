...
export const RoutesCentralized: any = {
    ...
    IC_PARAM_URL_PLATFORM_VERSION_UPDATE: 'api/platform/save_version',
    IC_PARAM_URL_VCC_BALANCE_ALLOCATION: 'api/vcc/balance_allocation',
    IC_PARAM_URL_VCC_CREATE: 'api/vcc/create_vcc',
    IC_PARAM_URL_VCC_UPDATE: 'api/vcc/update_vcc',
    ...
    IC_PARAM_URL_ACCOUNT_GET_MOVEMENT_CURRENCIES: 'api/account/get_movement_currencies',
