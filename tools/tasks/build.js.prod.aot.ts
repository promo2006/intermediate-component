...
import { TMP_CLIENT_DIR, TOOLS_DIR, BOOTSTRAP_DIR, BOOTSTRAP_MAIN_AOT, BOOTSTRAP_MODULE_AOT, TEMPLATE_CONFIG } from '../config';
...
export = () => {
  ...
  const tsProject = makeTsProject({}, TMP_CLIENT_DIR);
